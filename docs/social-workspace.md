...
القائمة الرئيسية تضم الكتيّبات، البنرات، ومنشورات التواصل. لكل قسم مشاريعه وإعداداته ومخرجاته الخاصة. تستخدم الأقسام خدمات إدخال العقارات والإكسل والصور نفسها دون خلط الحملات أو الملكية. مشاريع ومخرجات الإصدارات السابقة محفوظة.

المسار: **منشورات التواصل ← إنشاء حملة ← المنصة والتصميم ← بيانات المزاد ← العقارات ← الصور والشعارات ← المراجعة والتوليد ← الاعتماد والتنزيل**.
...
يسجل الناتج تقرير `preflight` مع المقاس وعدد الصفحات وإصدار الفحص. تبقى مراجعة النصوص والهوية والصور من المستخدم قبل الاعتماد؛ الفحص التقني لا يصادق على صحة الوقائع أو التفويض النظامي ولا يغني عن المراجعة البصرية. تعديل البيانات يلغي صلاحية اعتماد المخرجات، وإعادة التوليد بعد اعتماد سابق تنشئ نسخة جديدة وتحفظ الملف القديم.
