...
من القائمة الجانبية اختر **البنرات ← إنشاء حملة بنرات**. كل حملة مساحة مستقلة، ولا تظهر في قائمة الكتيّبات. مشاريع الكتيّبات السابقة تبقى كما هي، مع إمكان مراجعة مخرجات البنرات التاريخية داخل المشروع.
